...
type (
	...
	Authorizer interface {
		Authorized(ctx context.Context, transfer entity.Transfer) (bool, error)
	}

	// Notifier port
	Notifier interface {
		Notify(ctx context.Context, transfer entity.Transfer)
	}
	...
	CreateTransferPresenter interface {
		Output(transfer entity.Transfer) CreateTransferOutput
	}
